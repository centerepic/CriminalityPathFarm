...
local PickupTrack = game.Players.LocalPlayer.Character.Humanoid:LoadAnimation(game:GetService("ReplicatedStorage").Storage.Animations.Pickup1)
local BreakTrack = game.Players.LocalPlayer.Character.Humanoid:LoadAnimation(BreakAnim)
